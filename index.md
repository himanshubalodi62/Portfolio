...
- **Dev Tools:** Git, Docker, Flask, AWS (Basics)
...
- **Credit Card Fraud Detection**
  ...
  - Feature engineering, imbalance handling, and evaluation

- **Employee Performance Analysis**
  - Power BI dashboard with department-wise KPIs
  - DAX measures and visual insights

- **SQL Case Studies**
  - Salary gap analysis
  - Business-driven SQL queries using CTEs and window functions
...
- Machine learning model development (entry–intermediate)
- Data cleaning & preprocessing

I bring analytical thinking, clear communication, and practical solutions to every project.
